...
As in Experiment 1, participants rated the video as more enjoyable () than the
slider task (), STAT.
...
The results of the regression are shown in Figure~FIGNUM. As in Experiment 1,
participants are less likely to choose a new spinner when the current spinner
has a high value, $p>.999$. However, in this experiment we find no effect of
condition---participants were no more likely to explore a new spinner when there
